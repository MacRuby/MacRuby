...
module WEBrick
  ...
  module HTTPUtils
    ...
    # TODO: In cRuby, UNESCAPED, UNESCAPED_FORM and NONASCII are
    # generated by _make_regex(). However _make_regex() doesn't effect
    # in MacRuby. So we extracted these by hand.
