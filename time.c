...
time_mdump(VALUE time, SEL sel)
{
    ...
    if (!TIME_UTC_P(tobj)) {
	VALUE off = time_utc_offset(time, 0), div, mod;
...
static VALUE
time_mload(VALUE time, SEL sel, VALUE str)
{
    struct time_object *tobj;
    unsigned long p, s;
    time_t sec;
...
#define rb_intern(str) rb_intern_const(str)
    ...
    rb_objc_define_method(*(VALUE *)rb_cTime, "new", rb_class_new_instance_imp, -1);
    ...
    rb_objc_define_method(rb_cTime, "to_r", time_to_r, 0);
    ...
    rb_objc_define_method(rb_cTime, "initialize", time_init, -1);
    rb_objc_define_method(rb_cTime, "initialize_copy", time_init_copy, 1);

    rb_objc_define_method(rb_cTime, "localtime", time_localtime_m, -1);
    rb_objc_define_method(rb_cTime, "gmtime", time_gmtime, 0);
    rb_objc_define_method(rb_cTime, "utc", time_gmtime, 0);
    rb_objc_define_method(rb_cTime, "getlocal", time_getlocaltime, -1);
    ...
    rb_objc_define_method(rb_cTime, "round", time_round, -1);
    ...
    rb_objc_define_method(rb_cTime, "subsec", time_subsec, 0);
    ...
    rb_objc_define_method(rb_cTime, "marshal_dump", time_mdump, 0);
    rb_objc_define_method(rb_cTime, "marshal_load", time_mload, 1);
#endif
