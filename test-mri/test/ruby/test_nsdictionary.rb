...
class Hash
  def to_ns
    NSDictionary.dictionaryWithDictionary(self)
  end
end

class NSDictionaryWraper
  def [](obj={})
    NSMutableDictionary.dictionaryWithDictionary(obj)
  end
end

class TestNSDictionary < Test::Unit::TestCase
  ...
  def test_create
    assert_equal(@cls[1=>2, 3=>4], Hash[[[1,2],[3,4]]])
    assert_equal(@cls[1=>2, 3=>4], Hash[1,2,3,4])
    o = Object.new
    def o.to_hash() {1=>2} end
    assert_equal(@cls[1=>2], Hash[o], "[ruby-dev:34555]")
  end
